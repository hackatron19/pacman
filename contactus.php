  ...
  <div class="container mt-3">
    ...
    <div class="col-lg-6 mx-auto shadow-lg p-3 mb-5 bg-white rounded">
        ...
        <form action='' method='post' class="col-lg-11 mx-auto">
          ...
          <div class="input-group mb-2">
            <div class="input-group-prepend">
              <div class="input-group-text">Mob.&nbsp&nbsp</div>
            </div>
          ...
          <input type="submit" class="btn btn-primary btn-lg" role="button" style="margin-top:10px; margin-bottom: 20px;"
            value="Submit">
        </form>
      </div>
